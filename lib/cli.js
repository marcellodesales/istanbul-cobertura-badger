...
program.description("Generates a badge for a given Cobertura XML report")
  ...
  .option("-e, --excellentThreshold <n>", "The threshold for green badges, where coverage >= -e", parseInt)
  .option("-g, --goodThreshold <n>", "The threshold for yellow badges, where -g <= coverage < -e  ", parseInt)
